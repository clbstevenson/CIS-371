...
public class MyURL {
    ...
    public MyURL(String url) {
        ...
        String urlAfterScheme = (endOfScheme == 0) ? url.substring(endOfScheme) : url.substring(endOfScheme + 3);
        ...
        if(endOfDomain == -1) {
            ...
            if(endOfDomain == -1) {
                ...
                domainName = urlAfterScheme.substring(0);
                // Keep 'path' set as "/"
                // path = path;
                ...
                path = url.substring(endOfDomain); // include the found "/" character in the path.
            }
            ...
            if(endOfPort == -1) {
                ...
                port = Integer.parseInt(urlAfterDomain.substring(0));
                // Keep 'path' set as "/"
                // path = path;
